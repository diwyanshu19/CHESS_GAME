class Game {
  constructor(pieces) {
    this.board = document.querySelector(".main-container");
  ...
  pieceMove(event) {
    ...
    if (this.prev !== null && this.prev === name) {
      this.clearSquares();
      this.prev = null;
      return;
    }
  ...
  king_dead(color) {
    ...
    for (const piece of pieces) {
      ...
      if (allowedMoves.length) {
        console.log(allowedMoves, piece.position);
